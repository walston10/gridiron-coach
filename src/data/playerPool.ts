...
// Salary ranges reduced to ~60% of original for simplified 12-player roster
const POSITION_TIERS: Record<Position, TierConfig[]> = {
  QB: [
    { tier: 'ELITE', overallRange: [88, 95], salaryRange: [25, 33], potentialBonus: 0, color: '#FFD700' },
    { tier: 'STAR', overallRange: [82, 87], salaryRange: [17, 25], potentialBonus: 3, color: '#C0C0C0' },
    { tier: 'STARTER', overallRange: [75, 81], salaryRange: [9, 16], potentialBonus: 5, color: '#CD7F32' },
    { tier: 'BACKUP', overallRange: [68, 74], salaryRange: [3, 8], potentialBonus: 8, color: '#4A5568' },
    { tier: 'DEPTH', overallRange: [60, 67], salaryRange: [1, 2], potentialBonus: 12, color: '#2D3748' },
  ],
  RB: [
    { tier: 'ELITE', overallRange: [88, 95], salaryRange: [11, 15], potentialBonus: 0, color: '#FFD700' },
    { tier: 'STAR', overallRange: [82, 87], salaryRange: [7, 10], potentialBonus: 3, color: '#C0C0C0' },
    { tier: 'STARTER', overallRange: [75, 81], salaryRange: [5, 7], potentialBonus: 5, color: '#CD7F32' },
    { tier: 'BACKUP', overallRange: [68, 74], salaryRange: [2, 4], potentialBonus: 8, color: '#4A5568' },
    { tier: 'DEPTH', overallRange: [60, 67], salaryRange: [1, 2], potentialBonus: 12, color: '#2D3748' },
  ],
  WR: [
    { tier: 'ELITE', overallRange: [88, 95], salaryRange: [15, 21], potentialBonus: 0, color: '#FFD700' },
  ...
  TE: [
    { tier: 'ELITE', overallRange: [88, 95], salaryRange: [9, 12], potentialBonus: 0, color: '#FFD700' },
    { tier: 'STAR', overallRange: [82, 87], salaryRange: [6, 8], potentialBonus: 3, color: '#C0C0C0' },
    { tier: 'STARTER', overallRange: [75, 81], salaryRange: [4, 5], potentialBonus: 5, color: '#CD7F32' },
    { tier: 'BACKUP', overallRange: [68, 74], salaryRange: [2, 3], potentialBonus: 8, color: '#4A5568' },
    { tier: 'DEPTH', overallRange: [60, 67], salaryRange: [1, 1], potentialBonus: 12, color: '#2D3748' },
  ],
  OL: [
    { tier: 'ELITE', overallRange: [88, 95], salaryRange: [12, 17], potentialBonus: 0, color: '#FFD700' },
    { tier: 'STAR', overallRange: [82, 87], salaryRange: [8, 11], potentialBonus: 3, color: '#C0C0C0' },
    { tier: 'STARTER', overallRange: [75, 81], salaryRange: [5, 8], potentialBonus: 5, color: '#CD7F32' },
    { tier: 'BACKUP', overallRange: [68, 74], salaryRange: [3, 5], potentialBonus: 8, color: '#4A5568' },
    { tier: 'DEPTH', overallRange: [60, 67], salaryRange: [1, 2], potentialBonus: 12, color: '#2D3748' },
  ],
  DL: [
    { tier: 'ELITE', overallRange: [88, 95], salaryRange: [13, 18], potentialBonus: 0, color: '#FFD700' },
    { tier: 'STAR', overallRange: [82, 87], salaryRange: [9, 13], potentialBonus: 3, color: '#C0C0C0' },
    { tier: 'STARTER', overallRange: [75, 81], salaryRange: [6, 8], potentialBonus: 5, color: '#CD7F32' },
    { tier: 'BACKUP', overallRange: [68, 74], salaryRange: [3, 5], potentialBonus: 8, color: '#4A5568' },
    { tier: 'DEPTH', overallRange: [60, 67], salaryRange: [1, 2], potentialBonus: 12, color: '#2D3748' },
  ],
  LB: [
  ...
  CB: [
    ...
    { tier: 'STAR', overallRange: [82, 87], salaryRange: [8, 11], potentialBonus: 3, color: '#C0C0C0' },
    { tier: 'STARTER', overallRange: [75, 81], salaryRange: [5, 8], potentialBonus: 5, color: '#CD7F32' },
    { tier: 'BACKUP', overallRange: [68, 74], salaryRange: [2, 5], potentialBonus: 8, color: '#4A5568' },
    { tier: 'DEPTH', overallRange: [60, 67], salaryRange: [1, 2], potentialBonus: 12, color: '#2D3748' },
  ],
  S: [
    { tier: 'ELITE', overallRange: [88, 95], salaryRange: [10, 13], potentialBonus: 0, color: '#FFD700' },
    { tier: 'STAR', overallRange: [82, 87], salaryRange: [7, 9], potentialBonus: 3, color: '#C0C0C0' },
    { tier: 'STARTER', overallRange: [75, 81], salaryRange: [4, 6], potentialBonus: 5, color: '#CD7F32' },
    { tier: 'BACKUP', overallRange: [68, 74], salaryRange: [2, 4], potentialBonus: 8, color: '#4A5568' },
    { tier: 'DEPTH', overallRange: [60, 67], salaryRange: [1, 2], potentialBonus: 12, color: '#2D3748' },
  ],
  ST: [
    { tier: 'ELITE', overallRange: [90, 97], salaryRange: [9, 11], potentialBonus: 0, color: '#FFD700' },
    { tier: 'STAR', overallRange: [85, 89], salaryRange: [6, 8], potentialBonus: 2, color: '#C0C0C0' },
    { tier: 'STARTER', overallRange: [80, 84], salaryRange: [4, 5], potentialBonus: 4, color: '#CD7F32' },
    { tier: 'BACKUP', overallRange: [70, 79], salaryRange: [2, 3], potentialBonus: 6, color: '#4A5568' },
    { tier: 'DEPTH', overallRange: [60, 69], salaryRange: [1, 1], potentialBonus: 10, color: '#2D3748' },
  ],
};
