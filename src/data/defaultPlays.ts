import type { Play, PlayerAssignment, RouteType } from '../types';
...
const createAssignments = (
  ...
  return formation.positions.map(pos => {
    ...
    return {
      ...
      olBlocking: !pos.canRunRoutes ? 'PASS_PRO' : undefined,
    };
  });
};
...
export const DEFAULT_PLAYS: Play[] = [
  // ==================== RUN PLAYS ====================
  {
    ...
    }).map(a => a.positionSlot === 'RB' ? { ...a, isBallCarrier: true, isHandoffTarget: true } : a)
  ...
  },
  {
    ...
    tags: [],
    concept: 'Outside Run',
    notes: 'Outside run with pulling guard',
    createdAt: Date.now(),
    timesUsed: 0,
    successRate: 0,
  },
